...
export default function TicketCard({ ticketId }: { ticketId: Id<"tickets"> }) {
    ...
    return (
        <Link
            ...
            className={`block bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 border ${ticket.event.is_cancelled ? "border-red-800" : "border-gray-700"} overflow-hidden ${isPastEvent ? "opacity-75 hover:opacity-100" : ""}`}
        >
            <div className="p-5">
                ...
                <div className="space-y-2">
                    <div className="flex items-center text-gray-300">
                        <CalendarDays
                            className={`w-4 h-4 mr-2 ${ticket.event.is_cancelled ? "text-red-400" : ""}`}
                        />
